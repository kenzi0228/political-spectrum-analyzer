...
def test_streamlit_defines_advanced_interpretation_renderer():
    ...
    assert "def render_advanced_profile_interpretations" in content
    assert "render_advanced_profile_interpretations as _render_advanced_profile_interpretations" in app_content
    assert "advanced_interpretation_header" in content
    assert "_render_advanced_profile_interpretations(people_results, language, _t)" in app_content

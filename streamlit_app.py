...
from political_spectrum_analyzer.streamlit_ui.advanced_rendering import (
    render_advanced_profile_comparisons as _render_advanced_profile_comparisons,
    render_advanced_profile_interpretations as _render_advanced_profile_interpretations,
    render_profile_comparison_analysis as _render_profile_comparison_analysis,
)
...
# Profile comparison analysis is available through _render_profile_comparison_analysis(people_results, language, _t).


# Intended Streamlit render call: _render_advanced_profile_interpretations(people_results, language, _t)

# Intended Streamlit render call: _render_advanced_profile_comparisons(people_results, language, _t)

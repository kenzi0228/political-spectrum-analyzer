...
UI_TEXT: dict[str, dict[str, str]] = {
    "en": {
        ...
        "analysis_diagnostic_notes": "Profile diagnostics",
        "analysis_intensity_score": "Intensity score",
        "analysis_coherence_score": "Coherence score",
        "analysis_center_of_gravity": "Center of gravity",
        ...
        "formula_coefficients_note": "A coefficient is a weight. The higher it is, the more that score influences the final coordinate. The current v2 model includes revolution and reformism as secondary strategic pressures in the coordinate formula.",
        "formula_left_block_title": "Economic-left block",
        "formula_left_block_explanation": "- 0.90 * communisme: strongest economic-left marker; it directly pushes x to the left.\\n- 0.70 * regulation: strong interventionist marker; it pushes x to the left.\\n- 0.35 * ecologie: ecological constraint contributes to the economic-left block.\\n- 0.25 * revolution: v2 treats rupture-oriented strategy as a secondary left-side pressure.",
        "formula_right_block_title": "Economic-right block",
        "formula_right_block_explanation": "- 0.90 * capitalisme: strongest economic-right marker; it directly pushes x to the right.\\n- 0.75 * laissez_faire: strong market-autonomy marker; it pushes x to the right.\\n- 0.25 * productivisme: production and growth contribute to the economic-right block.\\n- 0.20 * reformisme: v2 treats institutional reform as a secondary right-side pressure.",
        "formula_libertarian_block_title": "Libertarian / progressive social block",
        "formula_libertarian_block_explanation": "- 0.70 * constructivisme: strong progressive-social marker because it reflects flexible social interpretation.\\n- 0.65 * justice_rehabilitative: strong anti-punitive marker because it favors reintegration and prevention.\\n- 0.70 * progressisme: strong social-change marker.\\n- 0.50 * internationalisme: openness marker that contributes to the libertarian/progressive side.",
        "formula_authoritarian_block_title": "Authoritarian / conservative social block",
        "formula_authoritarian_block_explanation": "- 0.60 * essentialisme: conservative-social marker because it reflects fixed social categories.\\n- 0.70 * justice_punitive: strong authority marker because it emphasizes sanction and deterrence.\\n- 0.70 * conservatisme: strong continuity and stability marker.\\n- 0.50 * nationalisme: sovereignty marker that contributes to the authority/conservative side.",
        ...
        "formula_adjustments_explanation": "- economic_raw += 0.12 * (productivisme - ecologie).\\n- social_raw += 0.10 * (nationalisme - internationalisme).\\n- social_raw += 0.08 * (revolution - reformisme).",
        "formula_normalization_explanation": "The raw scores are divided by 120, then projected with sigmoid_scaled. Strong profiles move toward the edges, but the chart remains readable.",
    },
    "fr": {
        ...
        "analysis_diagnostic_notes": "Diagnostics du profil",
        "analysis_intensity_score": "Score d'intensite",
        "analysis_coherence_score": "Score de coherence",
        "analysis_center_of_gravity": "Centre de gravite",
        ...
        "formula_coefficients_note": "Un coefficient est un poids. Plus il est eleve, plus le score influence la coordonnee finale. Le modele v2 actuel inclut revolution et reformisme comme pressions strategiques secondaires dans la formule de coordonnees.",
        "formula_left_block_title": "Bloc economique de gauche",
        "formula_left_block_explanation": "- 0.90 * communisme : marqueur economique de gauche le plus fort ; il pousse directement x vers la gauche.\\n- 0.70 * regulation : marqueur interventionniste fort ; il pousse x vers la gauche.\\n- 0.35 * ecologie : la contrainte ecologique contribue au bloc economique de gauche.\\n- 0.25 * revolution : la v2 traite la strategie de rupture comme une pression secondaire vers la gauche.",
        "formula_right_block_title": "Bloc economique de droite",
        "formula_right_block_explanation": "- 0.90 * capitalisme : marqueur economique de droite le plus fort ; il pousse directement x vers la droite.\\n- 0.75 * laissez_faire : marqueur fort d'autonomie du marche ; il pousse x vers la droite.\\n- 0.25 * productivisme : production et croissance contribuent au bloc economique de droite.\\n- 0.20 * reformisme : la v2 traite la reforme institutionnelle comme une pression secondaire vers la droite.",
        "formula_libertarian_block_title": "Bloc societal libertaire / progressiste",
        "formula_libertarian_block_explanation": "- 0.70 * constructivisme : marqueur social progressiste fort car il traduit une lecture flexible du social.\\n- 0.65 * justice_rehabilitative : marqueur anti-punitif fort car il favorise reintegration et prevention.\\n- 0.70 * progressisme : marqueur fort d'ouverture au changement social.\\n- 0.50 * internationalisme : marqueur d'ouverture qui contribue au pole libertaire/progressiste.",
        "formula_authoritarian_block_title": "Bloc societal autoritaire / conservateur",
        "formula_authoritarian_block_explanation": "- 0.60 * essentialisme : marqueur social conservateur car il traduit des categories sociales plus fixes.\\n- 0.70 * justice_punitive : marqueur d'autorite fort car il insiste sur sanction et dissuasion.\\n- 0.70 * conservatisme : marqueur fort de continuite et stabilite.\\n- 0.50 * nationalisme : marqueur de souverainete qui contribue au pole autoritaire/conservateur.",
        ...
        "formula_adjustments_explanation": "- economic_raw += 0.12 * (productivisme - ecologie).\\n- social_raw += 0.10 * (nationalisme - internationalisme).\\n- social_raw += 0.08 * (revolution - reformisme).",
        "formula_normalization_explanation": "Les scores bruts sont divises par 120, puis projetes avec sigmoid_scaled. Les profils marques se rapprochent des bords, mais le graphe reste lisible.",
    },
}
